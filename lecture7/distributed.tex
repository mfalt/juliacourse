...
\usepackage{fourier}\usepackage[scale=0.85]{tgheros}\linespread{0.95}
...
\begin{frame}[fragile]{Environment setup}{}
	...
	\begin{enumerate}
		...
		\begin{minted}[framesep=2mm]{julia}
...
addprocs([(@sprintf("philon-%2.2d",i),4) for i in 2:12], topology=:master_worker)
		...
		\begin{minted}[breaklines, fontsize=\small, framesep=2mm]{julia}
using Distributed
...
\begin{minted}[numbersep=3pt, gobble=0, frame=none, fontsize=\small, framesep=2mm]{julia}
...
\begin{minted}[breaklines,numbersep=3pt, gobble=0, frame=none, fontsize=\small, framesep=2mm]{julia}
...
\begin{minted}[breaklines,numbersep=3pt, frame=none, fontsize=\small, framesep=3mm]{julia}
...
\begin{description}
	...
	\begin{minted}[breaklines,numbersep=3pt, gobble=0, fontsize=\small, framesep=1mm, frame=none]{julia}
pmap(10:-1:1) do i
       sleep(i)
end
	\end{minted}
